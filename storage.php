...
$sql = "SELECT * FROM products WHERE category='Storage'";
...
$sql = "SELECT * FROM products 
        WHERE category='Storage' AND sub_category='StorageDevices'";
$result = $conn->query($sql);
...
<div class="products">
    <?php
$sql = "SELECT * FROM products 
        WHERE category='Storage' AND sub_category='StorageDevices2'";
$result = $conn->query($sql);
