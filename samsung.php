...
<title> SAMSUNG E-TRIC CENTER</title>
...
$sql = "SELECT * FROM products 
        WHERE category='Samsung' AND sub_category='Smartphones'";
$result = $conn->query($sql);
...
<?php
$sql = "SELECT * FROM products 
        WHERE category='Samsung' AND sub_category='Tablets'";
$result = $conn->query($sql);
...
<?php
$sql = "SELECT * FROM products 
        WHERE category='Samsung' AND sub_category='SPens'";
$result = $conn->query($sql);
