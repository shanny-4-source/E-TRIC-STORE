...
$sql = "SELECT * FROM products WHERE category='Oraimo'";
...
$sql = "SELECT * FROM products 
        WHERE category='Oraimo' AND sub_category='Headsets'";
$result = $conn->query($sql);
...
<?php
$sql = "SELECT * FROM products 
        WHERE category='Oraimo' AND sub_category='Speakers'";
$result = $conn->query($sql);
...
<?php
$sql = "SELECT * FROM products 
        WHERE category='Oraimo' AND sub_category='Watches'";
$result = $conn->query($sql);
